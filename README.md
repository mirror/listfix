...
listFix is cloned from: http://listfix.sourceforge.net/
...
## Requirements
* ~~JRE 1.6 - no promises of compatibility for OS-specific features on Macs as I don't own one~~ JRE is build in
